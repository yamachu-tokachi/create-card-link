const INLINE_CARD_STYLE = "display: flex; /* 横並びレイアウトの基本 */              align-items: stretch; /* 子要素をカード高さに揃える */              text-decoration: none; color: inherit; font-family: 'Inter', sans-serif; background-color: #ffffff; border-radius: 0.75rem; /* 12px */              box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1); overflow: hidden; margin-bottom: 1.5rem; /* カード間のマージン 24px */              width: 100%; /* 親要素の幅に合わせる */              max-width: 640px; /* カードの最大幅 40rem */              height: 12rem; /* 画像と同じ高さに固定 (192px) */              margin-left: auto; /* 中央寄せ */              margin-right: auto;";
